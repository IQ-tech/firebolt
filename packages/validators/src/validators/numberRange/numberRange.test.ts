...
describe("Validate correct values", () => {
  test.each([
    ...
    { value: "R$ 1.000.000", minNumber: 1212, thousandsSeparatorSymbol: "." },
    { value: "R$ 1.000.000,25", minNumber: 1000000, thousandsSeparatorSymbol: "." },
  ])(
  ...
  test.each([
    ...
    { value: "R$ 1.000.000,25", minNumber: 1000000.30, thousandsSeparatorSymbol: "." },
  ])(
    "These values should not pass on number range validation %s",
    ({ value, minNumber, maxNumber, thousandsSeparatorSymbol }) => {
      expect(
        numberRange.run(value, {
          minNumber,
